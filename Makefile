...
# Source files
SERVER_SOURCES = server/server_main.c server/server.c server/auth.c database/database.c server/group.c common/protocol.c common/router.c server/friend.c
